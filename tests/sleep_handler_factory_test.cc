...
class SleepHandlerFactoryTest : public ::testing::Test {
    public:
...
TEST_F(SleepHandlerFactoryTest, SleepFactoryTest) {
    Sleep_Handler_Factory handler_factory = Sleep_Handler_Factory(config);
    ...
    Request_Handler_Sleep* request_sleep_handler = handler_factory.create("/sleep", "/sleep");
