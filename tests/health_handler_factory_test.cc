...
class HealthHandlerFactoryTest : public ::testing::Test {
    public:
...
TEST_F(HealthHandlerFactoryTest, HealthFactoryTest) {
    Health_Handler_Factory handler_factory = Health_Handler_Factory(config);
    ...
    Request_Handler_Health* request_health_handler = handler_factory.create("/health", "/health");
