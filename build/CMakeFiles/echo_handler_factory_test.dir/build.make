...
CMakeFiles/echo_handler_factory_test.dir/tests/echo_handler_factory_test.cc.o: CMakeFiles/echo_handler_factory_test.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/usr/src/projects/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object CMakeFiles/echo_handler_factory_test.dir/tests/echo_handler_factory_test.cc.o"
...
bin/echo_handler_factory_test: lib/libgtest_maind.a
...
bin/echo_handler_factory_test: lib/libgtestd.a
bin/echo_handler_factory_test: /usr/lib/x86_64-linux-gnu/libboost_log.a
...
bin/echo_handler_factory_test: CMakeFiles/echo_handler_factory_test.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/usr/src/projects/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable bin/echo_handler_factory_test"
	$(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/echo_handler_factory_test.dir/link.txt --verbose=$(VERBOSE)
	/usr/bin/cmake -D TEST_TARGET=echo_handler_factory_test -D TEST_EXECUTABLE=/usr/src/projects/build/bin/echo_handler_factory_test -D TEST_EXECUTOR= -D TEST_WORKING_DIR=/usr/src/projects/tests -D TEST_EXTRA_ARGS= -D TEST_PROPERTIES= -D TEST_PREFIX= -D TEST_SUFFIX= -D TEST_FILTER= -D NO_PRETTY_TYPES=FALSE -D NO_PRETTY_VALUES=FALSE -D TEST_LIST=echo_handler_factory_test_TESTS -D CTEST_FILE=/usr/src/projects/build/echo_handler_factory_test[1]_tests.cmake -D TEST_DISCOVERY_TIMEOUT=5 -D TEST_XML_OUTPUT_DIR= -P /usr/share/cmake-3.22/Modules/GoogleTestAddTests.cmake
...
CMakeFiles/echo_handler_factory_test.dir/depend:
	cd /usr/src/projects/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /usr/src/projects /usr/src/projects /usr/src/projects/build /usr/src/projects/build /usr/src/projects/build/CMakeFiles/echo_handler_factory_test.dir/DependInfo.cmake --color=$(COLOR)
