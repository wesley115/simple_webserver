add_test( RequestHandlerDispatcherTest.GetHandlerEcho /usr/src/projects/build/bin/request_handler_dispatcher_test [==[--gtest_filter=RequestHandlerDispatcherTest.GetHandlerEcho]==] --gtest_also_run_disabled_tests)
...
add_test( RequestHandlerDispatcherTest.GetHandler404 /usr/src/projects/build/bin/request_handler_dispatcher_test [==[--gtest_filter=RequestHandlerDispatcherTest.GetHandler404]==] --gtest_also_run_disabled_tests)
...
add_test( RequestHandlerDispatcherTest.GetHandlerHealth /usr/src/projects/build/bin/request_handler_dispatcher_test [==[--gtest_filter=RequestHandlerDispatcherTest.GetHandlerHealth]==] --gtest_also_run_disabled_tests)
...
add_test( RequestHandlerDispatcherTest.GetHandlerCrud /usr/src/projects/build/bin/request_handler_dispatcher_test [==[--gtest_filter=RequestHandlerDispatcherTest.GetHandlerCrud]==] --gtest_also_run_disabled_tests)
...
add_test( RequestHandlerDispatcherTest.GetHandlerStatic /usr/src/projects/build/bin/request_handler_dispatcher_test [==[--gtest_filter=RequestHandlerDispatcherTest.GetHandlerStatic]==] --gtest_also_run_disabled_tests)
