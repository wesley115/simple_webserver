...
include("/usr/src/projects/build/meme_handler_factory_test[1]_include.cmake")
include("/usr/src/projects/build/request_handler_meme_test[1]_include.cmake")
add_test(integration_tests "bash" "/usr/src/projects/tests/integration_tests/integration_tests.sh")
set_tests_properties(integration_tests PROPERTIES  WORKING_DIRECTORY "/usr/src/projects/tests/integration_tests" _BACKTRACE_TRIPLES "/usr/src/projects/CMakeLists.txt;223;add_test;/usr/src/projects/CMakeLists.txt;0;")
subdirs("googletest")
