add_test( LoggerTest.LogTrace /usr/src/projects/build_coverage/bin/logger_test [==[--gtest_filter=LoggerTest.LogTrace]==] --gtest_also_run_disabled_tests)
...
add_test( LoggerTest.LogDebug /usr/src/projects/build_coverage/bin/logger_test [==[--gtest_filter=LoggerTest.LogDebug]==] --gtest_also_run_disabled_tests)
...
add_test( LoggerTest.LogInfo /usr/src/projects/build_coverage/bin/logger_test [==[--gtest_filter=LoggerTest.LogInfo]==] --gtest_also_run_disabled_tests)
...
add_test( LoggerTest.LogWarning /usr/src/projects/build_coverage/bin/logger_test [==[--gtest_filter=LoggerTest.LogWarning]==] --gtest_also_run_disabled_tests)
...
add_test( LoggerTest.LogError /usr/src/projects/build_coverage/bin/logger_test [==[--gtest_filter=LoggerTest.LogError]==] --gtest_also_run_disabled_tests)
...
add_test( LoggerTest.LogFatal /usr/src/projects/build_coverage/bin/logger_test [==[--gtest_filter=LoggerTest.LogFatal]==] --gtest_also_run_disabled_tests)
