...
CMakeFiles/request_handler_crud_test.dir/tests/request_handler_crud_test.cc.o: CMakeFiles/request_handler_crud_test.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/usr/src/projects/build_coverage/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object CMakeFiles/request_handler_crud_test.dir/tests/request_handler_crud_test.cc.o"
...
bin/request_handler_crud_test: lib/libgtest_main.a
...
bin/request_handler_crud_test: lib/libgtest.a
bin/request_handler_crud_test: /usr/lib/x86_64-linux-gnu/libboost_log.a
bin/request_handler_crud_test: /usr/lib/x86_64-linux-gnu/libboost_filesystem.a
...
bin/request_handler_crud_test: CMakeFiles/request_handler_crud_test.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/usr/src/projects/build_coverage/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable bin/request_handler_crud_test"
	$(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/request_handler_crud_test.dir/link.txt --verbose=$(VERBOSE)
	/usr/bin/cmake -D TEST_TARGET=request_handler_crud_test -D TEST_EXECUTABLE=/usr/src/projects/build_coverage/bin/request_handler_crud_test -D TEST_EXECUTOR= -D TEST_WORKING_DIR=/usr/src/projects/tests -D TEST_EXTRA_ARGS= -D TEST_PROPERTIES= -D TEST_PREFIX= -D TEST_SUFFIX= -D TEST_FILTER= -D NO_PRETTY_TYPES=FALSE -D NO_PRETTY_VALUES=FALSE -D TEST_LIST=request_handler_crud_test_TESTS -D CTEST_FILE=/usr/src/projects/build_coverage/request_handler_crud_test[1]_tests.cmake -D TEST_DISCOVERY_TIMEOUT=5 -D TEST_XML_OUTPUT_DIR= -P /usr/share/cmake-3.22/Modules/GoogleTestAddTests.cmake
...
CMakeFiles/request_handler_crud_test.dir/depend:
	cd /usr/src/projects/build_coverage && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /usr/src/projects /usr/src/projects /usr/src/projects/build_coverage /usr/src/projects/build_coverage /usr/src/projects/build_coverage/CMakeFiles/request_handler_crud_test.dir/DependInfo.cmake --color=$(COLOR)
